...
// Validaciones para actualizar usuario (Administrador)
exports.validateUsuarioUpdate = [
  body('nombre')
    .optional()
    .trim()
    .isLength({ min: 3, max: 255 })
  ...
  body('telefono')
    .optional()
    .matches(/^[0-9]{10}$/)
    .withMessage('Teléfono inválido (Debe ser un número de 10 dígitos)'),
  body('area')
    .optional()
    .isIn([
      'cultivos',
...
// Validaciones para actualizar perfil (Usuario mismo)
...
// Validaciones para cambiar contraseña por parte de Administrador
exports.validateAdminChangePassword = [
  body('newPassword')
    .isLength({ min: 6, max: 255 })
    .withMessage('La nueva contraseña debe tener al menos 6 caracteres'),
];
